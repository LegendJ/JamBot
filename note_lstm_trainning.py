...
fd = {'shifted': shifted, 'lr': learning_rate, 'emdim': note_embedding_dim, 'opt': optimizer,
...
# full connect layer: the prob of all the notes in vocabulary to be played next
model.add(Dense(note_vocab_size))
